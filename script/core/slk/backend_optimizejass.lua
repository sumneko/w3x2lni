...
return function (w2l, archive)
    local common   = archive:get 'common.j'   or archive:get 'scripts\\common.j'   or w2l.data_loader(w2l.mpq .. '\\scripts\\common.j')
    local blizzard = archive:get 'blizzard.j' or archive:get 'scripts\\blizzard.j' or w2l.data_loader(w2l.mpq .. '\\scripts\\blizzard.j')
