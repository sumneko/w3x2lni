return {
{
    ...
    { 'CHG', '移除WE文件时不转换触发器'},
    { 'FIX', '修正可能会崩溃的问题' },
    { 'FIX', '修正混淆脚本可能使逻辑错误的问题', '注册了实数变量变化事件后不混淆全局实数变量。'},
    { 'FIX', '修正部分对象在slk后消失的问题', '对象ID可以被转换为数字。'},
},
{
    version = '1.8.2',
...
},
{
    ...
    { 'FIX', '修正优化脚本后取负运算错误的问题', '- (100 + 10 * n) --> -100 + 10 * n' },
    { 'FIX', '修正混淆脚本会混淆japi函数的问题', '导致使用了japi的地图在混淆脚本后无法使用' },
},
{
    version = '1.8',
    { 'NEW', 'slk时可以选择优化脚本' },
