...
function w2l:map_save(name, buf)
    ...
    assert(upgrade.R002.gqer[1] == nil)
    assert(upgrade.R002.gqer[2] == '')
    assert(upgrade.R002.gqer[3] == '')
    assert(upgrade.R002.gqer[4] == nil)
    assert(upgrade.R002.gqer[5] == nil)
    assert(upgrade.R002.gqer[6] == nil)
    assert(upgrade.R002.gqer[7] == nil)
    assert(upgrade.R002.gqer[8] == nil)
    assert(upgrade.R002.gqer[9] == nil)
    assert(upgrade.R002.gqer[10] == nil)
end
